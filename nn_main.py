...
if __name__ == '__main__':
    ...
    w1, w2, w3, w4, b1, b2, b3, b4, losses = minibatch_gd(epoch, w1, w2, w3, w4, b1, b2, b3, b4, x_train, y_train, 10)
    train_time = time.time()
    print("Training Time for ", epoch, "epochs: ", train_time - start_time)
    np.save('w1', w1)
    np.save('w2', w2)
    np.save('w3', w3)
    np.save('w4', w4)
    ...
    test_time = time.time()
    print("Testing Time: ", test_time - test_start_time)
